...
const BUNDLED_PROVIDERS: Record<string, () => Promise<(opts: Record<string, unknown>) => BundledSDK>> = {
...
type CustomModelLoader = (sdk: BundledSDK, modelID: string, options?: Record<string, unknown>, model?: Model) => Promise<unknown>
